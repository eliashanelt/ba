...
# module references:
# redpitaya_mem_interface, signal_clipper, signal_gain, signal_merge, signal_split, freq_mapper, frequency_counter, pow2
...
proc create_hier_cell_FrequencyCounter { parentCell nameHier } {
  ...
  set block_cell_name freq_mapper_0
  if { [catch {set freq_mapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $freq_mapper_0 eq "" } {
...
proc create_root_design { parentCell } {
  ...
  # Create instance: redpitaya_mem_interf_0, and set properties
  set block_name redpitaya_mem_interface
  set block_cell_name redpitaya_mem_interf_0
  if { [catch {set redpitaya_mem_interf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $redpitaya_mem_interf_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: signal_clipper_0, and set properties
  set block_name signal_clipper
  set block_cell_name signal_clipper_0
  if { [catch {set signal_clipper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signal_clipper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: signal_gain_0, and set properties
  set block_name signal_gain
  set block_cell_name signal_gain_0
  if { [catch {set signal_gain_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signal_gain_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: signal_merge_0, and set properties
  set block_name signal_merge
  set block_cell_name signal_merge_0
  if { [catch {set signal_merge_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signal_merge_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: xlc_reset1, and set properties
  set xlc_reset1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlc_reset1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {10} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net FrequencyCounter_M_AXIS_OUT [get_bd_intf_pins FrequencyCounter/M_AXIS_OUT] [get_bd_intf_pins signal_gain_0/S_AXIS]
  connect_bd_intf_net -intf_net PS7_M00_AXI [get_bd_intf_pins PS7/M00_AXI] [get_bd_intf_pins redpitaya_mem_interf_0/s_axi]
  ...
  connect_bd_intf_net -intf_net signal_clipper_0_M_AXIS_OUT [get_bd_intf_pins signal_clipper_0/M_AXIS_OUT] [get_bd_intf_pins signal_merge_0/S_AXIS]
  connect_bd_intf_net -intf_net signal_gain_0_M_AXIS [get_bd_intf_pins signal_clipper_0/S_AXIS_IN] [get_bd_intf_pins signal_gain_0/M_AXIS]
  connect_bd_intf_net -intf_net signal_merge_0_M_AXIS [get_bd_intf_pins axis_red_pitaya_dac_0/S_AXIS] [get_bd_intf_pins signal_merge_0/M_AXIS]
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins FrequencyCounter/clk] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins signal_clipper_0/clk] [get_bd_pins signal_gain_0/clk]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs redpitaya_mem_interf_0/s_axi/reg0] -force
